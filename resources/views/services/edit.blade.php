@extends('layouts.app')
@push('pg_btn')
    <a href="{{route('service.index')}}" class="btn btn-sm btn-neutral">All SErvices</a>
@endpush
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-body">
                    {!! Form::open(['route' => ['service.update',$service], 'method'=>'put','files' => true]) !!}
                    <h6 class="heading-small text-muted mb-4">Service information</h6>
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        {{ Form::label('title', 'Service title', ['class' => 'form-control-label']) }}
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        {!! Form::textarea('content', $service->content, ['id'=>"summernote", 'class'=> 'form-control',]) !!}
                                    </div>
                                </div>
