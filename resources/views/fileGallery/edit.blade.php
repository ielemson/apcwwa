...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-body">
                    {!! Form::open(['route' => ['gallery.update', $gallery], 'method'=>'put', 'files' => true]) !!}
                    <h6 class="heading-small text-muted mb-4">Gallery information</h6>
                        <div class="pl-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('category', $gallery->category, ['class' => 'form-control']) }}
                                        </div>
                                    </div>
                                </div>
                         ...
                         <div class="col-md-6 justify-center">
                             <img src="{{$gallery->image_path}}" alt="" width="200" height="200">
                         </div>
                        </div>
