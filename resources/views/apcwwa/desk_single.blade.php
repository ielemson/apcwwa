...
@section('banner')
    @include('apcwwa.pageSection',['title_1'=>"From The Desk Of $desk->post",'title_2'=>"From The Desk Of $desk->post"])
@endsection
                    ...
                    <div class="single-post">
                        ...
                        <div class="post-details">
                            ...
                            <div class="main-image-box">
                                ...
                                <figure class="image"><img src="{{$desk->user_photo}}" alt="desk" style="width: 100%; max-height:80vh"></figure>
                                <h2>{{$desk->name}} <br/> <small style="font-size: 1rem"><b>{{$desk->post}}</b></small></h2>
                                {{-- <h2></h2> --}}
                            </div>
